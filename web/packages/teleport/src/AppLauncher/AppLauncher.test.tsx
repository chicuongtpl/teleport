...
// Round-trip test: verifies the full cycle from URL generation through
// React Router matching and param decoding. The bug exists at this
// boundary - generatePath does not encode, so the slash in the ARN
// creates extra path segments that break routing.
      ...
      <MemoryRouter initialEntries={[url]}>
        <Routes>
          <Route
            ...
            element={
              <ArnCapture onArn={arn => (capturedArn = arn)} />
            }
          />
        </Routes>
      </MemoryRouter>
