...
export interface SubmitEventRequest {
    ...
    event: {
        ...
        /**
         * @generated from protobuf field: prehog.v1alpha.UIAccessListDefineAccessEvent ui_access_list_define_access_event = 107;
         */
        uiAccessListDefineAccessEvent: UIAccessListDefineAccessEvent;
    } | {
        oneofKind: "uiAccessListDefineIdentitiesEvent";
        /**
         * @generated from protobuf field: prehog.v1alpha.UIAccessListDefineIdentitiesEvent ui_access_list_define_identities_event = 108;
         */
        uiAccessListDefineIdentitiesEvent: UIAccessListDefineIdentitiesEvent;
    } | {
        oneofKind: "uiAccessListDefineBasicInfoEvent";
        /**
         * @generated from protobuf field: prehog.v1alpha.UIAccessListDefineBasicInfoEvent ui_access_list_define_basic_info_event = 109;
         */
        uiAccessListDefineBasicInfoEvent: UIAccessListDefineBasicInfoEvent;
    } | {
        oneofKind: "uiAccessListDefineMembersEvent";
        /**
         * @generated from protobuf field: prehog.v1alpha.UIAccessListDefineMembersEvent ui_access_list_define_members_event = 110;
         */
        uiAccessListDefineMembersEvent: UIAccessListDefineMembersEvent;
    } | {
        oneofKind: "uiAccessListDefineOwnersEvent";
        /**
         * @generated from protobuf field: prehog.v1alpha.UIAccessListDefineOwnersEvent ui_access_list_define_owners_event = 111;
         */
        uiAccessListDefineOwnersEvent: UIAccessListDefineOwnersEvent;
    } | {
        oneofKind: "uiAccessListStartEvent";
        /**
         * @generated from protobuf field: prehog.v1alpha.UIAccessListStartEvent ui_access_list_start_event = 112;
         */
        uiAccessListStartEvent: UIAccessListStartEvent;
    } | {
        oneofKind: "uiAccessListCompleteEvent";
        /**
         * @generated from protobuf field: prehog.v1alpha.UIAccessListCompleteEvent ui_access_list_complete_event = 113;
         */
        uiAccessListCompleteEvent: UIAccessListCompleteEvent;
    } | {
        oneofKind: "uiAccessListIntegrateEvent";
        /**
         * @generated from protobuf field: prehog.v1alpha.UIAccessListIntegrateEvent ui_access_list_integrate_event = 114;
         */
        uiAccessListIntegrateEvent: UIAccessListIntegrateEvent;
    } | {
        oneofKind: "uiAccessListCustomEvent";
        /**
         * @generated from protobuf field: prehog.v1alpha.UIAccessListCustomEvent ui_access_list_custom_event = 115;
         */
...
class SubmitEventRequest$Type extends MessageType<SubmitEventRequest> {
    constructor() {
        super("prehog.v1alpha.SubmitEventRequest", [
            ...
            { no: 107, name: "ui_access_list_define_access_event", kind: "message", oneof: "event", T: () => UIAccessListDefineAccessEvent },
            { no: 108, name: "ui_access_list_define_identities_event", kind: "message", oneof: "event", T: () => UIAccessListDefineIdentitiesEvent },
            { no: 109, name: "ui_access_list_define_basic_info_event", kind: "message", oneof: "event", T: () => UIAccessListDefineBasicInfoEvent },
            { no: 110, name: "ui_access_list_define_members_event", kind: "message", oneof: "event", T: () => UIAccessListDefineMembersEvent },
            { no: 111, name: "ui_access_list_define_owners_event", kind: "message", oneof: "event", T: () => UIAccessListDefineOwnersEvent },
            { no: 112, name: "ui_access_list_start_event", kind: "message", oneof: "event", T: () => UIAccessListStartEvent },
            { no: 113, name: "ui_access_list_complete_event", kind: "message", oneof: "event", T: () => UIAccessListCompleteEvent },
            { no: 114, name: "ui_access_list_integrate_event", kind: "message", oneof: "event", T: () => UIAccessListIntegrateEvent },
            { no: 115, name: "ui_access_list_custom_event", kind: "message", oneof: "event", T: () => UIAccessListCustomEvent }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* prehog.v1alpha.SessionSummaryAccessEvent session_summary_access_event */ 106:
                    ...
                    break;
                case /* prehog.v1alpha.UIAccessListDefineAccessEvent ui_access_list_define_access_event */ 107:
                    message.event = {
                        oneofKind: "uiAccessListDefineAccessEvent",
                    ...
                    break;
                case /* prehog.v1alpha.UIAccessListDefineIdentitiesEvent ui_access_list_define_identities_event */ 108:
                    message.event = {
                        oneofKind: "uiAccessListDefineIdentitiesEvent",
                    ...
                    break;
                case /* prehog.v1alpha.UIAccessListDefineBasicInfoEvent ui_access_list_define_basic_info_event */ 109:
                    message.event = {
                        oneofKind: "uiAccessListDefineBasicInfoEvent",
                    ...
                    break;
                case /* prehog.v1alpha.UIAccessListDefineMembersEvent ui_access_list_define_members_event */ 110:
                    message.event = {
                        oneofKind: "uiAccessListDefineMembersEvent",
                    ...
                    break;
                case /* prehog.v1alpha.UIAccessListDefineOwnersEvent ui_access_list_define_owners_event */ 111:
                    message.event = {
                        oneofKind: "uiAccessListDefineOwnersEvent",
                    ...
                    break;
                case /* prehog.v1alpha.UIAccessListStartEvent ui_access_list_start_event */ 112:
                    message.event = {
                        oneofKind: "uiAccessListStartEvent",
                    ...
                    break;
                case /* prehog.v1alpha.UIAccessListCompleteEvent ui_access_list_complete_event */ 113:
                    message.event = {
                        oneofKind: "uiAccessListCompleteEvent",
                    ...
                    break;
                case /* prehog.v1alpha.UIAccessListIntegrateEvent ui_access_list_integrate_event */ 114:
                    message.event = {
                        oneofKind: "uiAccessListIntegrateEvent",
                    ...
                    break;
                case /* prehog.v1alpha.UIAccessListCustomEvent ui_access_list_custom_event */ 115:
                    message.event = {
                        oneofKind: "uiAccessListCustomEvent",
    ...
    internalBinaryWrite(message: SubmitEventRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* prehog.v1alpha.UIAccessListDefineAccessEvent ui_access_list_define_access_event = 107; */
        if (message.event.oneofKind === "uiAccessListDefineAccessEvent")
            UIAccessListDefineAccessEvent.internalBinaryWrite(message.event.uiAccessListDefineAccessEvent, writer.tag(107, WireType.LengthDelimited).fork(), options).join();
        /* prehog.v1alpha.UIAccessListDefineIdentitiesEvent ui_access_list_define_identities_event = 108; */
        if (message.event.oneofKind === "uiAccessListDefineIdentitiesEvent")
            UIAccessListDefineIdentitiesEvent.internalBinaryWrite(message.event.uiAccessListDefineIdentitiesEvent, writer.tag(108, WireType.LengthDelimited).fork(), options).join();
        /* prehog.v1alpha.UIAccessListDefineBasicInfoEvent ui_access_list_define_basic_info_event = 109; */
        if (message.event.oneofKind === "uiAccessListDefineBasicInfoEvent")
            UIAccessListDefineBasicInfoEvent.internalBinaryWrite(message.event.uiAccessListDefineBasicInfoEvent, writer.tag(109, WireType.LengthDelimited).fork(), options).join();
        /* prehog.v1alpha.UIAccessListDefineMembersEvent ui_access_list_define_members_event = 110; */
        if (message.event.oneofKind === "uiAccessListDefineMembersEvent")
            UIAccessListDefineMembersEvent.internalBinaryWrite(message.event.uiAccessListDefineMembersEvent, writer.tag(110, WireType.LengthDelimited).fork(), options).join();
        /* prehog.v1alpha.UIAccessListDefineOwnersEvent ui_access_list_define_owners_event = 111; */
        if (message.event.oneofKind === "uiAccessListDefineOwnersEvent")
            UIAccessListDefineOwnersEvent.internalBinaryWrite(message.event.uiAccessListDefineOwnersEvent, writer.tag(111, WireType.LengthDelimited).fork(), options).join();
        /* prehog.v1alpha.UIAccessListStartEvent ui_access_list_start_event = 112; */
        if (message.event.oneofKind === "uiAccessListStartEvent")
            UIAccessListStartEvent.internalBinaryWrite(message.event.uiAccessListStartEvent, writer.tag(112, WireType.LengthDelimited).fork(), options).join();
        /* prehog.v1alpha.UIAccessListCompleteEvent ui_access_list_complete_event = 113; */
        if (message.event.oneofKind === "uiAccessListCompleteEvent")
            UIAccessListCompleteEvent.internalBinaryWrite(message.event.uiAccessListCompleteEvent, writer.tag(113, WireType.LengthDelimited).fork(), options).join();
        /* prehog.v1alpha.UIAccessListIntegrateEvent ui_access_list_integrate_event = 114; */
        if (message.event.oneofKind === "uiAccessListIntegrateEvent")
            UIAccessListIntegrateEvent.internalBinaryWrite(message.event.uiAccessListIntegrateEvent, writer.tag(114, WireType.LengthDelimited).fork(), options).join();
        /* prehog.v1alpha.UIAccessListCustomEvent ui_access_list_custom_event = 115; */
        if (message.event.oneofKind === "uiAccessListCustomEvent")
            UIAccessListCustomEvent.internalBinaryWrite(message.event.uiAccessListCustomEvent, writer.tag(115, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
